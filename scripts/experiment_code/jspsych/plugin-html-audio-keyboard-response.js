/** Customized plugin by Angelique I. Delarazan */

var jsPsychHtmlAudioKeyboardResponse = (function (jspsych) {
    'use strict';
    ...
    /**
     * html-audio-keyboard-response
     * jsPsych plugin for displaying a stimulus and recording an audio response through a microphone
     * Modified to allow stopping recording and continuing with a keyboard key press ("b").
     */
    class HtmlAudioKeyboardResponsePlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial) {
        ...
        // Add keydown event listener for the "b" key
        document.addEventListener("keydown", this.keydownHandler.bind(this, display_element, trial));
      }
  
      keydownHandler(display_element, trial, event) {
    ...
    HtmlAudioKeyboardResponsePlugin.info = info;
  
    return HtmlAudioKeyboardResponsePlugin;
  })(jsPsychModule);
